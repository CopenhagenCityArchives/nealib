            ...
            var fkeyTest = new ForeignKeyTest(AV.TableIndex.Tables, notification => {
                switch (notification.Type)
                {
                    case NEA.Utility.NotificationType.ForeignKeyTestBlank:
                        var blankNoti = notification as NEA.Utility.ForeignKeyTestBlankNotification;
                        blankCount += blankNoti.Count.Value;
                        break;
                    case NEA.Utility.NotificationType.ForeignKeyTestError:
                        var errorNoti = notification as NEA.Utility.ForeignKeyTestErrorNotification;
